...
public class LoginSteps extends CommonMethods {
    ...
    public void user_enters_valid_username_and_invalid_password() {
      ...
      sendText(loginpage.passwordbox,"123354");
    }
    ...
    @When("user enters different {string} and {string} and verifies the {string} for all the combinations")
    public void user_enters_different_and_and_verifies_the_for_all_the_combinations(String usernamevalue, String passwordvalue, String error) {
